...
#### 1.Создаём машины А и B (web-a и web-b). Используем два файла main_machine.tf [main_machine.tf](https://github.com/Qshar1408/Kursovaya2025/blob/main/files/terraform/main_machine.tf) (в котором находятся непосредственно параметры для VM), а так же main_machine_disk.tf (в нём указаны образы диска для будущих машин) 
